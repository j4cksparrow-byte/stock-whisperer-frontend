-- Phase 1: Core Infrastructure Setup - Database Schema Enhancement (Fixed)
...
CREATE TABLE IF NOT EXISTS public.trending_stocks (
    ...
    UNIQUE(symbol, exchange, trend_date)
);
...
CREATE INDEX IF NOT EXISTS idx_trending_stocks_date ON public.trending_stocks(trend_date DESC);
